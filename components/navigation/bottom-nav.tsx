    ...
    >
      <div className="flex h-14 items-center justify-around">
        {navigationItems.map((item) => {
          ...
          const showBadge = item.nameKey === 'dashboard' && actionCount > 0
          return (
            <Link
              key={item.nameKey}
              href={item.href}
            ...
            >
              ...
              {showBadge && (
                <span className="absolute top-1.5 left-1/2 ml-1.5 flex items-center justify-center min-w-[16px] h-[16px] rounded-full bg-destructive text-white text-[10px] font-bold leading-none px-1">
